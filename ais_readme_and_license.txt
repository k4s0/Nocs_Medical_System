...
Script packet made by: 	Psychobastard
Version:		15102016
latest update:		15.10.2016
...
-	kaso2mod	for his text revisions,fixes and better translation https://github.com/kaso2mod
-------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------


How to use:
- 	Copy the ais_injruy folder, the init.sqf and the description.ext into your own mission folder.
- 	Edit the setup_ais.sqf data in the ais_injury folder if necessary.
-------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------
...
- 	Injury state without being completely dead.
- 	Compatible with missions without respawn.
- 	Drag, carry and drop injured units.
- 	Change the damage tolerance of your units.
- 	Visual bleeding effects.
- 	Unconscious units are able to go prone (press "forward") and fire until they empty their magazine.
- 	If a previously unconscious unit starts to shoot, the enemy will engage him (until he dies).
- 	An unconscious unit is not able to walk, throw grenades, reload or take any other action.
- 	The player starting the healing process can abort it by pressing "backwards" if needed (for example if he is under fire).
- 	Markers show injured units on the map.
- 	In-game 3D icons reveal injured units within a radius of 30 meters.
- 	Healing progress is visualized (indicator bar).
- 	Different states of health after a unit receives first aid (depends on the ability of the attendant as well as the equipment used - FAKs & Medkits).
- 	A critical hit (direct shot to the head or a  heavy explosions) will kill a unit immediately if  realistic-mode is enabled.
- 	Deadcam dialog implemented.
- 	A famous war quote is displayed during the deadcam dialog.
-------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------
